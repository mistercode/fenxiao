...
@interface ExcSortViewController ()
{
    float width;
    float height;
    NSArray *sortArray;
...
@implementation ExcSortViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [exclusiveVC setSortStr:[sortArray objectAtIndex:indexPath.row]];
