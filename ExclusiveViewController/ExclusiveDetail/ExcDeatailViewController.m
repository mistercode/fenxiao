...
@interface ExcDeatailViewController ()
{
    UIView *siftView;
    float width;
    float height;
...
@implementation ExcDeatailViewController
...
- (IBAction)excDetailBack:(id)sender {
    [self.navigationController popViewControllerAnimated:YES];
}

- (IBAction)deatilMore:(id)sender {
