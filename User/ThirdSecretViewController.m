...
@interface ThirdSecretViewController ()

@end

@implementation ThirdSecretViewController
@synthesize certainBtn;

- (void)viewDidLoad {
    [super viewDidLoad];
    [self createNav];
     [[certainBtn layer]setCornerRadius:8.0];//圆角
