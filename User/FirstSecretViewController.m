...
@interface FirstSecretViewController ()

@end

@implementation FirstSecretViewController
@synthesize nextBtn;
- (void)viewDidLoad {
    [super viewDidLoad];
    [self createNav];
...
{
    SecondSecretViewController *secondSecret = [[SecondSecretViewController alloc] init];
    [self.navigationController pushViewController:secondSecret animated:YES];
    CLog(@"========下一步========");
}
